    ...
    return (
      <form onSubmit={handleSubmit} className={`flex items-center gap-2 ${className}`}>
        <input
          ...
          className="w-32 text-center text-xs font-mono font-semibold tracking-widest px-3 py-1.5 rounded-lg border border-border bg-background focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all placeholder:tracking-normal"
        />
        <button
          type="submit"
          disabled={code.trim().length < 4 || joining}
          className="p-1.5 rounded-lg bg-primary text-primary-foreground disabled:opacity-40 transition-all hover:bg-primary/90 btn-animated"
        >
