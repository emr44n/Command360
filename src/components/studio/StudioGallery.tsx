...
export function StudioGallery({
    ...
    return (
      <div
        ...
        className={`flex items-center gap-1.5 rounded-none px-2 py-1.5 text-xs cursor-pointer transition-all group ${
          isSelected ? 'bg-red-600/20 text-red-300' : 'hover:bg-[#2b2d31] dash-light:hover:bg-black/[0.05] text-[#9aa0a8] dash-light:text-[#5B6169]'
        }`}
      ...
      >
        ...
        {editingEventId === evt.id ? (
          <input
            ...
            className="flex-1 h-5 text-xs bg-[#2b2d31] dash-light:bg-white border border-zinc-600 dash-light:border-black/10 rounded-none px-1 text-white dash-light:text-[#16191E]"
            autoFocus
        ...
        {targetName && (
          <span className="text-[9px] text-[#9aa0a8] dash-light:text-[#5B6169] truncate max-w-[60px]">{targetName}</span>
        )}
        {evt.actions.length > 0 && (
          <span className="text-[9px] bg-zinc-700/50 dash-light:bg-[#EAE6DD] text-[#9aa0a8] dash-light:text-[#5B6169] px-1 rounded-none">
            {evt.actions.length}
          </span>
        )}
        {onTriggerEvent && (
          ...
          <button
            className="p-0.5 text-[#9aa0a8] dash-light:text-[#5B6169] opacity-0 group-hover:opacity-100 hover:text-[#2E9E63] transition-all cursor-pointer"
        ...
        <Tooltip><TooltipTrigger asChild>
        <button
          className="p-0.5 text-[#9aa0a8] dash-light:text-[#5B6169] opacity-0 group-hover:opacity-100 hover:text-red-400 transition-all cursor-pointer"
  ...
  return (
    <div className="flex h-full flex-col bg-[#2b2d31] dash-light:bg-white text-white dash-light:text-[#16191E]">
      <Tabs defaultValue={initialTab} key={initialTab} className="flex h-full flex-col">
        <div ref={tabContainerRef} className="flex border-b border-[#1e1f22] dash-light:border-black/10 shrink-0">
          <TabsList className="w-full bg-transparent p-0 h-auto rounded-none gap-0">
            <Tooltip><TooltipTrigger asChild><TabsTrigger value="images" className="flex-1 min-w-0 flex items-center justify-center gap-1 px-1 py-1.5 text-[9px] font-semibold rounded-none border-b-[3px] transition-all duration-200 data-[state=active]:border-red-500 data-[state=active]:text-white dash-light:data-[state=active]:text-[#16191E] data-[state=active]:bg-[#3a1c1c] dash-light:data-[state=active]:bg-[#F7E9E7] data-[state=active]:[&_svg]:text-red-400 data-[state=inactive]:border-transparent data-[state=inactive]:text-zinc-700 dash-light:data-[state=inactive]:text-[#5B6169] data-[state=inactive]:bg-[#1a1b1e] dash-light:data-[state=inactive]:bg-[#F5F2EB] data-[state=inactive]:[&_svg]:text-zinc-700 dash-light:data-[state=inactive]:[&_svg]:text-[#5B6169] data-[state=inactive]:hover:text-white dash-light:data-[state=inactive]:hover:text-[#16191E] data-[state=inactive]:hover:bg-[#2a2b30] dash-light:data-[state=inactive]:hover:bg-white">
          ...
          <div className="flex items-center px-1 gap-0.5 border-b-2 border-transparent">
            ...
            <button
              ...
              className={`p-1 rounded-none transition-colors ${viewMode === 'grid' ? 'text-[#9aa0a8] dash-light:text-[#5B6169] bg-[#35363c] dash-light:bg-[#EAE6DD]' : 'text-[#9aa0a8] dash-light:text-[#5B6169] hover:text-white dash-light:hover:text-[#16191E]'}`}
            >
            ...
            <button
              ...
              className={`p-1 rounded-none transition-colors ${viewMode === 'list' ? 'text-[#9aa0a8] dash-light:text-[#5B6169] bg-[#35363c] dash-light:bg-[#EAE6DD]' : 'text-[#9aa0a8] dash-light:text-[#5B6169] hover:text-white dash-light:hover:text-[#16191E]'}`}
            >
        ...
        <TabsContent value="images" className="flex-1 overflow-y-auto px-2 pb-2 animate-[fadeIn_0.2s_ease-out]">
          ...
          <Button
            ...
            className="mt-2 w-full border-dashed border-zinc-600 dash-light:border-black/10 bg-[#383a40] dash-light:bg-[#EAE6DD] text-[#9aa0a8] dash-light:text-[#5B6169] hover:bg-zinc-700 dash-light:hover:bg-black/[0.05]"
          ...
          {uploading && (
            <div className="mt-1.5 h-1 w-full rounded-none bg-[#2b2d31] dash-light:bg-[#EAE6DD] overflow-hidden">
              <div className="h-1 bg-red-500 rounded-none transition-all duration-150" style={{ width: `${uploadProgress}%` }} />
            </div>
          )}
          {images.length === 0 && <p className="mt-4 text-center text-xs text-[#9aa0a8] dash-light:text-[#5B6169]">No images uploaded yet</p>}
          <div className={`mt-1.5 ${viewMode === 'grid' ? 'grid grid-cols-2 gap-1' : 'flex flex-col gap-0.5'}`}>
            {images.map((asset) => viewMode === 'list' ? (
              <div
                ...
                role="button"
                tabIndex={0}
                className="group flex items-center gap-2 px-1.5 py-1 rounded-none hover:bg-[#35363c] dash-light:hover:bg-black/[0.05] cursor-pointer transition-colors"
              ...
              >
                ...
                <span className="text-[9px] text-[#9aa0a8] dash-light:text-[#5B6169] truncate flex-1">{asset.name}</span>
                <button
                  className="p-0.5 text-[#9aa0a8] dash-light:text-[#5B6169] hover:text-red-400 opacity-0 group-hover:opacity-100 transition-opacity"
              ...
              <div
                ...
                role="button"
                tabIndex={0}
                className="group relative aspect-video overflow-hidden rounded-none border border-[#3f4147] dash-light:border-black/10 bg-[#383a40] dash-light:bg-[#EAE6DD] hover:border-zinc-500 dash-light:hover:border-black/20 cursor-grab active:cursor-grabbing"
                draggable onDragStart={(e) => handleAssetDragStart(e, asset)}
                onClick={() => addImageToCanvas(asset)}
              >
        ...
        <TabsContent value="videos" className="flex-1 overflow-y-auto px-2 pb-2 animate-[fadeIn_0.2s_ease-out]">
          ...
          <div className="mt-2 flex gap-1">
            <Button
              variant="outline" size="sm"
              className="flex-1 border-dashed border-zinc-600 dash-light:border-black/10 bg-[#383a40] dash-light:bg-[#EAE6DD] text-[#9aa0a8] dash-light:text-[#5B6169] hover:bg-zinc-700 dash-light:hover:bg-black/[0.05]"
            ...
            <Button
              variant="outline" size="sm"
              className={`border-zinc-600 dash-light:border-black/10 bg-[#383a40] dash-light:bg-[#EAE6DD] text-[#9aa0a8] dash-light:text-[#5B6169] hover:bg-zinc-700 dash-light:hover:bg-black/[0.05] px-2 ${showYoutubeInput ? 'border-red-500 bg-red-500/10 text-red-400' : ''}`}
            ...
            <div className="mt-1.5 mb-2 animate-in slide-in-from-top-1 duration-200">
              <div className="flex gap-1">
                <Input
                  ...
                  className="h-6 flex-1 border-zinc-600 dash-light:border-black/10 bg-[#1e1f22] dash-light:bg-[#F5F2EB] text-[9px] text-white dash-light:text-[#16191E] placeholder:text-[#9aa0a8] dash-light:placeholder:text-[#8A9098]"
                />
          ...
          {videos.length === 0 && <p className="mt-4 text-center text-xs text-[#9aa0a8] dash-light:text-[#5B6169]">No videos uploaded yet</p>}
          <div className={`mt-1.5 ${viewMode === 'grid' ? 'grid grid-cols-2 gap-1' : 'flex flex-col gap-0.5'}`}>
        ...
        <TabsContent value="placed" className="flex-1 overflow-y-auto px-2 pb-2 animate-[fadeIn_0.2s_ease-out]">
          {layers.length === 0 && <p className="mt-4 text-center text-xs text-[#9aa0a8] dash-light:text-[#5B6169]">No layers placed yet</p>}
            ...
            {layers.map((layer, idx) => (
              <div
                ...
                className={`flex w-full items-center gap-1.5 rounded-none px-1.5 py-1.5 text-left text-xs cursor-pointer transition-colors ${
                  selectedLayerId === layer.id ? 'bg-red-500/20 border-l-2 border-red-500 text-white' : 'text-[#9aa0a8] dash-light:text-[#5B6169] hover:bg-[#2b2d31] dash-light:hover:bg-black/[0.05]'
                } ${dragLayerIdx === idx ? 'opacity-50' : ''}`}
                onClick={() => onSelectLayer(layer.id)}
              >
                <GripVertical className="size-3 text-[#9aa0a8] dash-light:text-[#5B6169] shrink-0 cursor-grab active:cursor-grabbing" />
                {typeIcon(layer.type)}
                <span className="flex-1 truncate">{layer.name}</span>
                {!layer.visible && <span className="text-[10px] text-[#9aa0a8] dash-light:text-[#5B6169]">hidden</span>}
                <button onClick={e => { e.stopPropagation(); onDeleteLayer?.(layer.id) }} className="p-0.5 text-[#9aa0a8] dash-light:text-[#5B6169] hover:text-red-400 transition-colors shrink-0"><Trash2Icon className="size-2.5" /></button>
              </div>
            ))}
          </div>
        </TabsContent>
        ...
        <TabsContent value="audio" className="flex-1 overflow-y-auto px-2 pb-2 animate-[fadeIn_0.2s_ease-out]">
          ...
          {audios.length === 0 && <p className="mt-4 text-center text-xs text-[#9aa0a8] dash-light:text-[#5B6169]">No audio files uploaded yet</p>}
          <div className="mt-1.5 flex flex-col gap-0.5">
            {audios.map((asset) => (
              <div
                key={asset.id}
                className="flex items-center gap-2 px-2 py-1.5 rounded-none hover:bg-[#35363c] dash-light:hover:bg-black/[0.05] group"
              >
                <button
                ...
                <button
                  ...
                  className="text-[#9aa0a8] dash-light:text-[#5B6169] hover:text-white dash-light:hover:text-[#16191E] transition-colors"
                >
        ...
        <TabsContent value="text" className="flex-1 overflow-y-auto px-2 pb-2 animate-[fadeIn_0.2s_ease-out]">
          <Button variant="outline" size="sm" className="mt-2 w-full border-dashed border-zinc-600 dash-light:border-black/10 bg-[#383a40] dash-light:bg-[#EAE6DD] text-[#9aa0a8] dash-light:text-[#5B6169] hover:bg-zinc-700 dash-light:hover:bg-black/[0.05]"
          ...
          {layers.filter(l => l.type === 'text').length === 0 && <p className="mt-4 text-center text-xs text-[#9aa0a8] dash-light:text-[#5B6169]">No text layers yet</p>}
          <div className="mt-2 space-y-0.5">
            {layers.filter(l => l.type === 'text').map(layer => (
              <div key={layer.id} className={`group flex items-center gap-1.5 px-1.5 py-1 rounded-none cursor-pointer text-xs transition-colors ${selectedLayerId === layer.id ? 'bg-red-500/20 border-l-2 border-red-500 text-white' : 'text-[#9aa0a8] dash-light:text-[#5B6169] hover:bg-[#35363c] dash-light:hover:bg-black/[0.05]'}`} onClick={() => onSelectLayer(layer.id)}>
                <span className="text-[#9aa0a8] dash-light:text-[#5B6169] font-mono">T</span>
                <span className="flex-1 truncate text-[#9aa0a8] dash-light:text-[#5B6169]">{layer.text || layer.name}</span>
                <button onClick={e => { e.stopPropagation(); onDeleteLayer?.(layer.id) }} className="p-0.5 text-[#9aa0a8] dash-light:text-[#5B6169] hover:text-red-400 transition-opacity opacity-0 group-hover:opacity-100"><Trash2Icon className="size-2.5" /></button>
              </div>
            ))}
          </div>
        </TabsContent>
          ...
          <div className="mt-2 grid grid-cols-2 gap-1.5">
            {[{ name: 'Rectangle', w: 20, h: 12, color: '#4a5568' }, { name: 'Circle', w: 15, h: 15, color: '#4a5568' }, { name: 'Triangle', w: 15, h: 15, color: '#4a5568' }, { name: 'Line', w: 30, h: 0.5, color: '#4a5568' }, { name: 'Polygon', w: 15, h: 15, color: '#4a5568' }].map(p => (
              <button key={p.name} onClick={() => { if (p.name === 'Polygon' && onStartPolygonDraw) { onStartPolygonDraw() } else { onAddLayer({ type: 'shape', name: p.name, color: p.color, x: 10, y: 10, width: p.w, height: p.h, rotation: 0, opacity: 1, blendMode: 'normal', visible: true, locked: false }) } }}
                className="flex flex-col items-center gap-1 py-2.5 rounded-none border border-[#3f4147] dash-light:border-black/10 bg-[#383a40] dash-light:bg-[#EAE6DD] hover:bg-[#35363c] dash-light:hover:bg-black/[0.05] hover:border-zinc-500 dash-light:hover:border-black/20 transition-colors">
                ...
                <span className="text-[8px] text-[#9aa0a8] dash-light:text-[#5B6169]">{p.name}</span>
              </button>
            ))}
          </div>
          {layers.filter(l => l.type === 'shape').length === 0 && <p className="mt-4 text-center text-xs text-[#9aa0a8] dash-light:text-[#5B6169]">No shapes placed yet</p>}
          <div className="mt-2 space-y-0.5">
            {layers.filter(l => l.type === 'shape').map(layer => (
              <div key={layer.id} className={`group flex items-center gap-1.5 px-1.5 py-1 rounded-none cursor-pointer text-xs transition-colors ${selectedLayerId === layer.id ? 'bg-red-500/20 border-l-2 border-red-500 text-white' : 'text-[#9aa0a8] dash-light:text-[#5B6169] hover:bg-[#35363c] dash-light:hover:bg-black/[0.05]'}`} onClick={() => onSelectLayer(layer.id)}>
                {layer.name === 'Circle' ? <div className="w-4 h-4 rounded-full shrink-0" style={{ backgroundColor: layer.color || '#666' }} />
                  ...
                  : <div className="w-4 h-3 rounded-none shrink-0" style={{ backgroundColor: layer.color || '#666' }} />}
                <span className="flex-1 truncate text-[#9aa0a8] dash-light:text-[#5B6169]">{layer.name}</span>
                ...
                <button onClick={e => { e.stopPropagation(); onDeleteLayer?.(layer.id) }} className="p-0.5 text-[#9aa0a8] dash-light:text-[#5B6169] hover:text-red-400 transition-colors"><Trash2Icon className="size-2.5" /></button>
              </div>
            ))}
          </div>
        </TabsContent>
          ...
          <div className="mt-2 space-y-2">
            ...
            <div className="flex gap-1.5">
              <Input
                ...
                className="h-6 flex-1 border-[#3f4147] dash-light:border-black/10 bg-[#383a40] dash-light:bg-[#EAE6DD] text-xs text-white dash-light:text-[#16191E] placeholder:text-[#9aa0a8] dash-light:placeholder:text-[#8A9098]"
              />
              <Button
                variant="outline" size="sm"
                className="h-6 shrink-0 border-zinc-600 dash-light:border-black/10 bg-[#2b2d31] dash-light:bg-white px-2 text-[#9aa0a8] dash-light:text-[#5B6169] hover:bg-zinc-700 dash-light:hover:bg-black/[0.05]"
            ...
            <div className="flex gap-1.5">
              <Input
                ...
                className="h-5 flex-1 border-[#3f4147]/50 dash-light:border-black/10 bg-[#2b2d31]/50 dash-light:bg-white text-[10px] text-[#9aa0a8] dash-light:text-[#5B6169] placeholder:text-[#9aa0a8] dash-light:placeholder:text-[#8A9098]"
              />
              <Button
                variant="ghost" size="sm"
                className="h-5 shrink-0 px-1.5 text-[#9aa0a8] dash-light:text-[#5B6169] hover:text-white dash-light:hover:text-[#16191E]"
            ...
            {events.length === 0 && eventCategories.length === 0 && (
              <p className="mt-4 text-center text-xs text-[#9aa0a8] dash-light:text-[#5B6169]">No events yet</p>
            )}
                ...
                <div key={category.id}>
                  <div className="flex items-center gap-1.5 group">
                    <button
                      ...
                      className="flex items-center gap-1 flex-1 py-1 text-[10px] font-semibold text-[#9aa0a8] dash-light:text-[#5B6169] uppercase tracking-wider hover:text-white dash-light:hover:text-[#16191E] transition-colors cursor-pointer"
                    >
                      {isCollapsed ? <ChevronRight className="size-3" /> : <ChevronDown className="size-3" />}
                      <div className="size-1.5 rounded-full" style={{ backgroundColor: category.color || '#6366f1' }} />
                      {category.name}
                      <span className="text-[#9aa0a8] dash-light:text-[#5B6169] font-normal ml-1">({catEvents.length})</span>
                    </button>
                    <Tooltip><TooltipTrigger asChild>
                    <button
                      className="p-0.5 text-[#9aa0a8] dash-light:text-[#5B6169] opacity-0 group-hover:opacity-100 hover:text-red-400 transition-all cursor-pointer"
                  ...
                  {!isCollapsed && (
                    <div className="ml-2 space-y-0.5">
                      ...
                      {catEvents.length === 0 && (
                        <p className="text-[10px] text-[#9aa0a8] dash-light:text-[#5B6169] py-1 pl-2">No events in this category</p>
                      )}
                    </div>
                  )}
                </div>
            ...
            {uncategorizedEvents.length > 0 && (
              <div>
                {eventCategories.length > 0 && (
                  <div className="py-1 text-[10px] font-semibold text-[#9aa0a8] dash-light:text-[#5B6169] uppercase tracking-wider">
                    Uncategorized
                  </div>
                )}
