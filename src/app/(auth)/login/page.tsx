    ...
    <div className="relative">
      ...
      <div className="relative rounded-2xl border border-white/[0.06] bg-white/[0.02] p-8 [box-shadow:0_-20px_80px_-20px_rgba(255,255,255,0.03)_inset]">
        ...
        <div className="space-y-1 text-center mb-8">
          <h1 className="text-xl font-semibold tracking-tight text-white">Sign in to Command 360</h1>
        ...
        <div className="mt-8 space-y-3 text-center text-sm">
          ...
          <p>
            <Link href="/forgot-password" className="text-white/25 hover:text-white/50 transition-colors text-xs">
